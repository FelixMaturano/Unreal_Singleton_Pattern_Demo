...
#define UE_PROJECT_NAME SingletonPattern
#define UE_TARGET_NAME SingletonPatternEditor
#define UE_MODULE_NAME "SingletonPattern"
...
#define SINGLETONPATTERN_API DLLEXPORT
